'use strict';
/* build-hook-start *//*00001*/try { require('/Users/macbook/.trae/extensions/wallabyjs.console-ninja-1.0.451-universal/out/buildHook/index.js').default({tool: 'jest', checkSum: '208ebe9a75a12b6d6afbaaClJMUBdQDQMDBwIHB10HU1ZSUFgI', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/macbook/.trae/extensions/wallabyjs.console-ninja-1.0.451-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '208ebe9a75a12b6d6afbaaClJMUBdQDQMDBwIHB10HU1ZSUFgI', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
